...
abstract class $LocationCopyWith<$Res> {
  ...
  $Res call(
      ...
      double lat,
      double lon,
      @JsonKey(name: "tz_id", defaultValue: "error") String? tzid,
...
class _$_Location implements _Location {
  const _$_Location(
      ...
      required this.lat,
      required this.lon,
      @JsonKey(name: "tz_id", defaultValue: "error") this.tzid,
...
abstract class _Location implements Location {
  const factory _Location(
      ...
      @JsonKey(name: "tz_id", defaultValue: "error") final String? tzid,
